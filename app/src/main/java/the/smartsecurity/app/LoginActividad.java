...
public class LoginActividad extends AppCompatActivity implements View.OnClickListener{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(LoginActividad.this, "Datos de inicio de sesión incorrectos", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
